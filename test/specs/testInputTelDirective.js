describe('Unit testing teljs directive', function() {
    ...
    it('Formats a danish national number correctly', function() {
        ...
        var element = $compile('<form name="myform"><input name="number" type="tel" class="phone-input" international="false" default-area-code="45" ng-model="number"></form>')($rootScope);
    ...
    it('does not format an invalid danish national number correctly', function() {
        ...
        var element = $compile('<input type="tel" class="phone-input" international="false" default-area-code="45" ng-model="number">')($rootScope);
        $rootScope.$digest();
    ...
    it('Formats a danish national number correctly to international format using default-area-code', function() {
        $rootScope.number = '22334455';
        var element = $compile('<input type="tel" class="phone-input" international="true" default-area-code="45" ng-model="number">')($rootScope);
        $rootScope.$digest();
    ...
    it('Formats a danish number correctly', function() {
        $rootScope.number = '4522334455';
        var element = $compile('<input type="tel" class="phone-input" international="true" ng-model="number">')($rootScope);
        $rootScope.$digest();
    ...
    it('Formats a swedish national number correctly', function() {
        ...
        var element = $compile('<input type="tel" class="phone-input" international="false" default-area-code="46" ng-model="number">')($rootScope);
        $rootScope.$digest();
